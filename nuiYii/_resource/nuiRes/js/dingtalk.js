(function() {
    ...
    "use strict";
    var a = ["backbutton", "online", "offline", "pause", "resume", "swipeRefresh", "appLinkResponse", "internalPageLinkResponse", "networkEvent", "hostTaskEvent"];
    e.extend(e, {
        events: a
    })
}(__dd), function(e) {
    ...
    function n(a, n, i) {
        ...
        if (e.android) {
            var m = a.split("."),
                p = m.pop(),
                l = m.join(".");
            window.WebViewJavascriptBridgeAndroid && WebViewJavascriptBridgeAndroid(s, r, l, p, o)
    ...
    e.extend(e, {
        ...
        ready: function(n) {
            var i = function(a) {
                ...
                alert(2)
                if (null !== s && s.signature) {
                    if (e.ios) a.callHandler(r, s, function(e) {
                        var i = e || {},
                            o = i.errorCode,
                            s = i.errorMessage || "";
                        i.result;
    ...
    var m = function(a, n) {
            for (var i = a.split("."), o = e, s = 0, r = i.length; s < r; s++) s === r - 1 && (o[i[s]] = n), "undefined" == typeof o[i[s]] && (o[i[s]] = {}), o = o[i[s]]
        },
        p = function(a, o, s) {
            return c ? new Promise(function(r, d) {
                o = o || {}, o._onSuccess = o.onSuccess ||
                    function() {}, o._onFail = o.onFail ||
                    function() {}, o._onCancel = o.onCancel ||
                    function() {}, o.onSuccess = function() {
    ...
    for (var l in e.methods) e.methods[l].forEach(function(e) {
